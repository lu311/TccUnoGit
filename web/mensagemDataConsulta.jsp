<%-- 
    Document   : mensagemDataConsulta
    Created on : 09/11/2014, 17:23:46
    Author     : Lu311
--%>
...
<%
    ...
    try {
        if (!request.getParameter("pkgrupo").isEmpty()) {
            pdata1 = request.getParameter("data1");
            pdata2 = request.getParameter("data2");
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>consulta de usuarios por data</title>
                ...
                <div class="col-md-12">
                    <div class="well well-sm">
                        <form class="form-horizontal" method="post">
                            <fieldset>
                                <legend class="text-center header">Consulta de mensagem por data</legend>    

                                <legend class="text-center header">
                                    <div class="form-group">
                                        <span class="col-md-1 col-md-offset-2 text-left"><i class="glyphicon glyphicon-search bigicon"></i></span>
                                        <div class="col-md-8">
                                            <input id="texto" name="dataCons1" type="text" placeholder="Digite data inicial ano-mes-dia" class="form-control">
                                            <input id="texto" name="dataCons2" type="text" placeholder="Digite data final ano-mes-dia " class="form-control">
                                                ...
                                                <table class="table table-hover">
                                                    <%
                                                        try {
                                                            ...
                                                            lista = user.mensagemDataConsulta(request.getParameter("dataCons1"),request.getParameter("dataCons2"));
